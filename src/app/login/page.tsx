...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.message?.message || 'Invalid email or password');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-gray-900 mt-6 mb-1">Welcome back</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <a href={`${BACKEND_URL}/api/v1/auth/google`}
              className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl transition-colors text-sm">
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          ...
          <a href="/register" className="text-violet-600 font-medium hover:underline">Sign up</a>
        </p>
      </div>
    </div>
  );
